...
$ref = Edges "D:\Others-Github\smartisan_icon\iconpack\png\com.xingin.xhs.png"
$me = Edges $Png
...
"corner rows y:ref/me " + ((0..24 | ForEach-Object { "{0}:{1:N2}/{2:N2}" -f $_, $ref.rows[$_][0], $me.rows[$_][0] }) -join ' ')
